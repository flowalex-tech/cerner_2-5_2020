#!/bin/bash
# cerner_2^5_2020
#Script to import openvpn config files, I have proton vpn so I named the script after that but it should be generic enough to work work for any openvpn files
